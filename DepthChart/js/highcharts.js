...
(function (c) {
  'object' === typeof module && module.exports
    ...
    ? define('highcharts/modules/exporting', ['highcharts'], function (k) {
        c(k);
        c.Highcharts = k;
        return c;
      })
  ...
  k(c, 'modules/full-screen.src.js', [c['parts/Globals.js']], function (e) {
    (e.FullScreen = function (e) {
      ...
      init: function (e) {
        var c;
        e.requestFullscreen
          ? (c = e.requestFullscreen())
          : e.mozRequestFullScreen
          ? (c = e.mozRequestFullScreen())
          : e.webkitRequestFullscreen
          ? (c = e.webkitRequestFullscreen())
          : e.msRequestFullscreen && (c = e.msRequestFullscreen());
        if (c)
          c['catch'](function () {
  ...
  k(c, 'mixins/navigation.js', [], function () {
    return {
      ...
      addUpdate: function (e, c) {
        ...
        c.navigation.updates.push({update: e, context: c});
      },
    };
  });
  k(
    ...
    [c['parts/Globals.js'], c['parts/Utilities.js'], c['mixins/navigation.js']],
    function (e, c, k) {
      var t = c.isObject,
        E = c.objectEach;
      c = e.defaultOptions;
      ...
      e.post = function (a, b, f) {
        ...
        E(b, function (b, a) {
          w('input', {type: 'hidden', name: a, value: b}, null, d);
        });
        d.submit();
        F(d);
      };
      x(C.prototype, {
        ...
        getSVG: function (a) {
          ...
          this.axes.forEach(function (b) {
            b.userOptions.internalKey ||
              (b.userOptions.internalKey = e.uniqueKey());
          });
          ...
          this.axes.forEach(function (b) {
            ...
            a &&
              ((void 0 !== f && f !== a.min) ||
                (void 0 !== d && d !== a.max)) &&
              a.setExtremes(f, d, !0, !1);
          });
          c = l.getChartHTML();
          D(this, 'getSVG', {chartCopy: l});
        ...
        print: function () {
          function a(a) {
            (b.fixedDiv
              ? [b.fixedDiv, b.scrollingContainer]
              : [b.container]
            ).forEach(function (b) {
              a.appendChild(b);
            });
          ...
          if (!b.isPrinting) {
            ...
            [].forEach.call(c, function (b, a) {
              1 === b.nodeType &&
                ((f[a] = b.style.display), (b.style.display = 'none'));
            });
            a(d);
            setTimeout(function () {
              z.focus();
        ...
        contextMenu: function (a, b, f, d, c, r, l) {
          ...
          if (!h) {
            ...
            var k = w('div', {className: 'highcharts-menu'}, null, h);
            g.styledMode ||
              u(
                k,
                x(
            ...
            b.forEach(function (b) {
              'string' === typeof b &&
                (b = g.options.exporting.menuItemDefinitions[b]);
              if (t(b, !0)) {
                if (b.separator) var a = w('hr', null, null, k);
                  ...
                  (a = w(
                    ...
                    g.styledMode ||
                      ...
                      u(a, x({cursor: 'pointer'}, m.menuItemStyle)));
          ...
          b = {display: 'block'};
          f + g.exportMenuWidth > p
            ? (b.right = p - f - c - v + 'px')
            : (b.left = f - v + 'px');
          d + r + g.exportMenuHeight > B &&
        ...
        addButton: function (a) {
          ...
          if (!1 !== d.enabled) {
            ...
            d.text && d.symbol
              ...
              : d.text || x(g, {width: d.width, height: d.height, padding: 0});
            b.styledMode ||
              ((g['stroke-linecap'] = 'round'),
              (g.fill = q(g.fill, '#ffffff')),
              (g.stroke = q(g.stroke, 'none')));
            var n = f
              .button(d.text, 0, 0, B, g, k, m)
            ...
            if (d.symbol) {
              var h = f
                .symbol(d.symbol, d.symbolX - l / 2, d.symbolY - l / 2, l, l, {
                  width: l,
                  height: l,
                })
            ...
            n.add(b.exportingGroup).align(
              x(d, {width: n.width, x: q(d.x, b.buttonOffset)}),
              !0,
              'spacingBox',
            );
            b.buttonOffset +=
      ...
      C.prototype.inlineStyles = function () {
        ...
        function b(c) {
          function f(b, f) {
            ...
            for (r = e.length; r-- && !v; )
              v = e[r].test(f) || 'function' === typeof b;
            v ||
